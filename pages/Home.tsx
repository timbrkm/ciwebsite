    ...
    <div className="bg-skate-black">
      ...
      <section className="py-24 bg-white text-black relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
                <h2 className="text-6xl md:text-8xl font-headline leading-[0.85] mb-6">
                    THE HAGEN<br/><span className="text-skate-red">CONNECT</span>
                </h2>
                <p className="font-body text-xl text-gray-700 mb-8 max-w-md">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                     <Link to="/events" className="inline-flex items-center justify-center gap-2 bg-black text-white px-6 py-3 font-headline text-xl uppercase hover:bg-skate-accent hover:text-black transition-colors">
                        <Calendar size={20} /> Upcoming Events
                    </Link>
                     <Link to="/about" className="inline-flex items-center justify-center gap-2 border-2 border-black text-black px-6 py-3 font-headline text-xl uppercase hover:bg-black hover:text-white transition-colors">
            ...
            <div className="relative h-[400px] md:h-[500px] group">
                ...
                />
                 ...
                 <div className="absolute -top-6 -right-6 bg-skate-accent w-24 h-24 rounded-full flex items-center justify-center font-marker text-sm rotate-12 shadow-lg z-10 animate-pulse">
                    OPEN <br/> DAILY
                 </div>
            </div>
         </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div
            ...
            style={{
                // Skater failing/falling or thinking
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-20">
            <h2 className="text-6xl md:text-8xl font-headline text-white uppercase italic mb-6 text-shadow-lg">
                STUCK ON A <br/> <span className="text-skate-accent">KICKFLIP?</span>
            </h2>
            <p className="text-xl md:text-2xl font-body text-gray-300 mb-8 max-w-2xl mx-auto">
                Unser C.I. AI Coach analysiert dein Problem und gibt dir Tipps. 24/7 verfügbar.
            </p>
            <Link to="/coach" className="inline-flex items-center gap-2 bg-skate-red text-white px-8 py-4 font-headline text-2xl uppercase transform hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_white] transition-all">
